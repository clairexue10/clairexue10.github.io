  ...
  return (
    <section id="contact" className="py-24 border-t border-slate-200 dark:border-slate-800">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-slate-500 dark:text-slate-400 font-sans mb-16 max-w-lg">
        ...
        <div className="space-y-6">
          {LINKS.map((link) => (
            <div key={link.label} className="flex items-center gap-6">
              <span className="text-xs text-slate-400 dark:text-slate-500 font-sans uppercase tracking-widest w-20 shrink-0">
                {link.label}
              </span>
              <a
                href={link.href}
                ...
                rel="noreferrer"
                className="text-slate-900 dark:text-slate-100 font-sans hover:text-slate-500 dark:hover:text-slate-400 transition-colors underline underline-offset-4 decoration-slate-200 dark:decoration-slate-700 hover:decoration-slate-400"
              >
                {link.display}
              </a>
            </div>
